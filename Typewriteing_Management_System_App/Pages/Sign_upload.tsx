  ...
  const handleUploadPhoto = () => {
    if (validateForm()) {
      ...
      xhr.addEventListener('load', () => {
        ...
        showMessage({
          message: 'Your Signature Uploaded Successfully',
          type: 'success',
          duration: 3000,
          autoHide: true,
        });
      ...
      xhr.open('POST', `${SERVER_URL}/sign.php`);
      xhr.send(formData);
    // }
...
//       let errorMessage = '';
//   if (!tempID && !institution) {
//     errorMessage = 'Missing Tempno and Institution';
//   } else if (!tempID) {
//     errorMessage = 'Missing Tempno';
//   } else if (!institution) {
//     errorMessage = 'Missing Institution';
//   }
...
<Text style={{color:'red',}}>{InstitutionError}</Text>
  ...
  <Text style={styles.title}>Upload Your Signature Here</Text>
